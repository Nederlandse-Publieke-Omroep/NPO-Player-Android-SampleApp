    ...
    private val streamLinkSourceList: List<SourceWrapper> by lazy {
        listOf(
            SourceWrapper(
                ...
                imageUrl = "https://cdn-test.npoplayer.nl/player/test-kaspar/shorts_poster/WO_ZAPP_20338724.png",
                avType = AVType.VIDEO,
                isShort = true,
            ),
            SourceWrapper(
                ...
                offlineDownloadAllowed = false,
                preferThisImageUrlOverStreamLink = true,
                imageUrl = "https://cdn-test.npoplayer.nl/player/test-kaspar/shorts_poster/WO_ZAPP_20338725.png",
                avType = AVType.VIDEO,
                isShort = true,
            ),
            SourceWrapper(
                ...
                preferThisImageUrlOverStreamLink = true,
                imageUrl =
                    "https://cdn-test.npoplayer.nl/player/test-kaspar/shorts_poster/WO_ZAPP_20338667.png",
                avType = AVType.VIDEO,
                isShort = true,
            ),
            SourceWrapper(
